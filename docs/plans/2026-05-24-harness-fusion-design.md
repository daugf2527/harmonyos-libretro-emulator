...
| **S4-S6** | 按需 | 各 1 h | **P1**：H3 / C3 / B2 / CT3 / CT5 / FB1 / AG1 **+ SE1 / SE3 / PM1 / PM2 / SA1 / SC1 / SC2 / WT1 / NT1 / PG1 / OS1**（详见附录 A-L），每会话挑 1-2 项 | - | ✅ S4 完成 2026-05-25 (12/12 P1 项 closed)：FB1 + SC1 + SC2 + PG1 + CT3 + CT5 + B2 + SA1 + H3 + SE1 + NT1 + OS1（commit 17579d7 / d1b91a9 / 7938f80 / 9944fbb / c0d18bc / 待发）；PM2/WT1 已在 S2 顺带 |
