...
| **S4-S6** | 按需 | 各 1 h | **P1**：H3 / C3 / B2 / CT3 / CT5 / FB1 / AG1 **+ SE1 / SE3 / PM1 / PM2 / SA1 / SC1 / SC2 / WT1 / NT1 / PG1 / OS1**（详见附录 A-L），每会话挑 1-2 项 | - | 🟡 S4 持续：2026-05-25 落地 FB1 + SC1 + SC2 + PG1（commit 17579d7 + d1b91a9）+ CT3 + CT5；PM2/WT1 已在 S2 顺带；H3 / B2 / SE1 / SA1 / NT1 / OS1 待跑 |
