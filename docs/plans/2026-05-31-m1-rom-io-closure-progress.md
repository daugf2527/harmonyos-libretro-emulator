...
- [ ] 3.1 审计 LibraryRepository 字段 (30min) → 列出已有字段
- [ ] 3.2 补全缺失字段 (1h) → releaseYear/publisher/genre/playCount
- [ ] 3.3 Cover art 下载/缓存 (2h) → libretro thumbnails API + fallback
- [ ] 3.4 Platform 标签完整化 (1h) → GB/GBC/GBA/NES/SNES/MD/PS1/N64
- [ ] 3.5 Last-played 排序 (30min) → 默认按 lastPlayed desc
- [ ] 3.6 搜索/筛选 (1-2h) → title/platform 筛选
